...
def requested():
    ...
    phone=[]
    for i in a:
        url='https://www.fast2sms.com/dev/bulk?authorization=T4lGBF7h1RXgAfvKsoLWiCtrm2O9NeZw8EDqHj5uad0SPYVnpkaLExWXSmlrtsfdUGC2JigVBQjy6cwq&sender_id=FSTSMS&message=Need
